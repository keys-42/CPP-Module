...
int main() {
  ...
  std::cout << "--------ShrubberyCreationForm---------------- " << __FILE__
            << " in " << __LINE__ << std::endl;
  std::cout << "--------simple test-------------------- " << __FILE__ << " in "
            << __LINE__ << std::endl;
  {
    try {
  ...
  std::cout << "--------RobotomyRequestForm---------------- " << __FILE__
            << " in " << __LINE__ << std::endl;
  std::cout << "--------simple test-------------------- " << __FILE__ << " in "
            << __LINE__ << std::endl;
  {
  ...
  std::cout << "--------PresidentialPardonForm---------------- " << __FILE__
            << " in " << __LINE__ << std::endl;
  std::cout << "--------simple test-------------------- " << __FILE__ << " in "
            << __LINE__ << std::endl;
  {
    try {
      Bureaucrat bureaucrat("Jim", 1);
      form =
          intern->makeForm("PresidentialPardonForm", "presidentialPardonForm");
      std::cout << bureaucrat << std::endl;
      std::cout << *form;
      bureaucrat.signForm(*form);
      bureaucrat.executeForm(*form);
  ...
  std::cout << std::endl
            << "--------Invalid form name test-------------------- " << __FILE__
            << " in " << __LINE__ << std::endl;
  {
    try {
      Bureaucrat bureaucrat("Jim", 1);
