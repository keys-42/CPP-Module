...
ClapTrap::~ClapTrap() {
	std::cout << "ClapTrap defualt destructor called" << std::endl;
}
...
void ClapTrap::takeDamage(unsigned int amount) {
	...
	if (hit_points_ > amount)
		...
		hit_points_ = 0;
	std::cout << "ClapTrap " << this->getName() << " loses " << amount << " hit points."
			  << std::endl;
}
...
void ClapTrap::beRepaired(unsigned int amount) {
	...
	consumeEnergyPoints();
	hit_points_ += amount;
	std::cout << "ClapTrap " << this->getName() << " repairs itself by " << amount << " points."
			  << std::endl;
}
...
void ClapTrap::consumeEnergyPoints(void) {
	energy_points_--;
}
