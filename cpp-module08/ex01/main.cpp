...
int main() {
	{
		...
		std::cout << GREEN;
		std::cout << std::endl
				  << "--------empty-------- " << __FILE__ << " in " << __LINE__ << std::endl;
		std::cout << RESET;
		try {
		...
		std::cout << GREEN;
		std::cout << std::endl
				  << "--------only one stored,-------- " << __FILE__ << " in " << __LINE__
				  << std::endl;
		std::cout << RESET;
		try {
			sp.addNumber(6);
		...
		try {
			...
			std::cout << GREEN;
			std::cout << std::endl
					  << "--------max size 5{try add}-------- " << __FILE__ << " in " << __LINE__
					  << std::endl;
			sp.printContainer();
			std::cout << RESET;
			sp.addNumber(11);
		...
		try {
			std::cout << GREEN;
			std::cout << std::endl
					  << "--------shortestSpan && longestSpan-------- " << __FILE__ << " in "
					  << __LINE__ << std::endl;
			std::cout << RESET;
			std::cout << sp.shortestSpan() << std::endl;
			std::cout << sp.longestSpan() << std::endl;
...

	{
		std::cout << GREEN;
		std::cout << std::endl
				  << "--------big container 2147483-------- " << __FILE__ << " in " << __LINE__
				  << std::endl;
		std::cout << RESET;
		...
		try {
			...
			std::cout << "--------addNumber 1-------- " << __FILE__ << " in " << __LINE__
					  << std::endl;
			b.addNumber(1);
		} catch (std::exception& e) {
			std::cout << "exception: " << e.what() << std::endl;
...

	{
		std::cout << GREEN;
		std::cout << std::endl
				  << "--------INT_MIN and INT_MAX-------- " << __FILE__ << " in " << __LINE__
				  << std::endl;
		std::cout << RESET;
