...
int main()
{
    std::cout << "==========subject test==========" << std::endl;
    {
        ...
        std::cout << GREEN;
        std::cout << "it = mstack.begin()" << __FILE__ << " in " << __LINE__ << std::endl;   
        mstack.print();  
        std::cout << RESET;
        ...
        std::cout << std::endl;
        std::cout << GREEN;
        std::cout << "mstack => std::stack<int> copy " << __FILE__ << " in " << __LINE__ << std::endl;   
        std::cout << RESET;
    ...
    // {
    //     std::cout << GREEN;
    //     std::cout << "Testing if iterators of MutantStack and std::list behave the same." << __FILE__ << " in " << __LINE__ << std::endl; 
    //     std::cout << RESET;
    ...
    //         std::cout << "Iterators of MutantStack and std::list behave the same." << std::endl;
    //     } else {
    //         std::cout << "Iterators of MutantStack and std::list do not behave the same." << std::endl;
    //     }
    // }
