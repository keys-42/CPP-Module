...
AAnimal::AAnimal() : type_(""){ std::cout << "AAnimal Default constructor called" << std::endl; }

AAnimal::AAnimal(std::string name) : type_(name) { std::cout << "AAnimal Default constructor called" << std::endl; }
